...
Пройдите две части инструкции по порядку. В них собраны все обязательные команды и действия в интерфейсе, с примерами для Windows PowerShell и Linux. Проверенного публичного релиза и URL репозитория ещё нет: для тестирования используйте только проверенную версию исходников.
